...
export const products = pgTable('products', {
   ...
   currency: text('currancy').notNull().default('usd'),
...
// cascade = "delete children when parent id deleted" restrict = "don't delete the parent if any child still points at it"
...
// each line items is for exactly one order and one product
